...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-109c842a", module.exports)
  } else {
    hotAPI.update("_v-109c842a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var BinaryTreeOutput = function () {
    function BinaryTreeOutput() {
        var nodes = arguments.length <= 0 || arguments[0] === undefined ? '[]' : arguments[0];
        var parentNode = arguments[1];
        var containerID = arguments.length <= 2 || arguments[2] === undefined ? "#tree-container" : arguments[2];
    ...
    _createClass(BinaryTreeOutput, [{
        ...
        key: "analyzeTree",
        value: function analyzeTree(treeObj) {
            var _this = this;
        ...
        key: "modifyTree",
        value: function modifyTree(nodes) {
            var _this2 = this;
    ...
    return BinaryTreeOutput;
}();

exports.default = BinaryTreeOutput;
...
exports.default = initTernaryTree;
